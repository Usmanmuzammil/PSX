...
Route::group(['middleware' => ['auth:admin']], function () {
    ...
    // user management Yajra Routes
    Route::get('/admin/user/details/depositrequest/{id}',[usercontroller::class, 'depositRequest']);
    Route::get('/admin/user/details/transactiontable/{id}',[usercontroller::class, 'TransactionHistory']);
    Route::get('/admin/user/details/trade/{id}',[usercontroller::class, 'Trade']);
    Route::get('/admin/user/details/withdrawrequest/{id}',[usercontroller::class, 'withdrawRequest']);
